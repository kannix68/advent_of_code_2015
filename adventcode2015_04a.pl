...
$result = $algo->exec('00000', 'abcdef'); # == 609043
ok( $result == 609043, "example 1 payload='abcdef'" );

$result = $algo->exec('00000', 'pqrstuv'); # == 1048970
ok( $result == 1048970, "example 1 payload='pqrstuv'" );

Test::More::done_testing();
infolog("Tests done!");

$result = $algo->exec('00000', $data);
