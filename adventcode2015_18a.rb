...
class Test01Examples < Test::Unit::TestCase
  def test_example_01
    day18solver = Day18Solver.new
    day18solver.fn = "adventcode2015_test14.txt"
    day18solver.log_level = 2
    day18solver.infolog("day18solver instantiated")
    day18solver.algo_exec(t_race)    
  end
...
class Test02Solution < Test::Unit::TestCase
  def test_solution_1
    day18solver = Day18Solver.new
    day18solver.fn = "adventcode2015_in18.txt"
    day18solver.log_level = 2
    day18solver.infolog("day18solver instantiated")
    day18solver.algo_exec(t_race)
  end
